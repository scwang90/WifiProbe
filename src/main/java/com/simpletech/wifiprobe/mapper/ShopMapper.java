...
public interface ShopMapper extends MybatisMultiDao<Shop>{
	 ...
	 * @return 改变的行数
	 */
	@Insert("INSERT INTO t_shop ( id , config_visit_expired , config_user_expired , config_visit_signal , config_visit_expired_wifi , config_visit_signal_wifi , config_api_visit_counts , config_api_visit_duration , config_api_visit_period , config_api_visit_period_min_duration , config_api_liveness , create_time , update_time ) VALUES ( #{id} , #{configVisitExpired} , #{configUserExpired} , #{configVisitSignal} , #{configVisitExpiredWifi} , #{configVisitSignalWifi} , #{configApiVisitCounts} , #{configApiVisitDuration} , #{configApiVisitPeriod} , #{configApiVisitPeriodMinDuration} , #{configApiLiveness} , #{createTime} , #{updateTime} )")
