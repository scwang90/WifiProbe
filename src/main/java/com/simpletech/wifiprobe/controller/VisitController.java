...
public class VisitController extends GeneralController<Visit>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody Visit model) throws Exception {
	...
	public Object update(@RequestBody Visit model) throws Exception {
