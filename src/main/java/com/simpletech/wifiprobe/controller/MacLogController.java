...
/**
 * 数据库表t_mac_log 的Controller层实现
 * @author 树朾
 * @date 2015-11-03 17:09:44 中国标准时间
 */
@RestController
@Intent("数据库表t_mac_log")
@RequestMapping("maclog")
public class MacLogController extends GeneralController<MacLog>{

	@Autowired
	MacLogService service;
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody MacLog model) throws Exception {
	...
	public Object update(@RequestBody MacLog model) throws Exception {
