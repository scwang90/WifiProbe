...
@Intent("数据库表t_wifi")
@RequestMapping("wifi")
public class WifiController extends GeneralController<Wifi>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody Wifi model) throws Exception {
	...
	public Object update(@RequestBody Wifi model) throws Exception {
