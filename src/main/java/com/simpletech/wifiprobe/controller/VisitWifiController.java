...
/**
 * 数据库表t_visit_wifi 的Controller层实现
 * @author 树朾
 * @date 2015-11-03 17:09:44 中国标准时间
 */
@RestController
@Intent("数据库表t_visit_wifi")
@RequestMapping("visitwifi")
public class VisitWifiController extends GeneralController<VisitWifi>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody VisitWifi model) throws Exception {
	...
	public Object update(@RequestBody VisitWifi model) throws Exception {
