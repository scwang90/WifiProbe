...
public class StatisticsCustomerTypeServiceTester {
	...
	public void customer() throws Exception{
		Object result = service.customer("1", monthf.parse("2015-11-06"), monthf.parse("2015-11-30"));
		System.out.println(JacksonUtil.toJson(result).replace("{","\n{"));
	}
	@Test
	public void customerTrend()throws Exception{
		Object result = service.customerTrend("1", Period.day, monthf.parse("2015-11-06"), monthf.parse("2015-11-30"));
		System.out.println(JacksonUtil.toJson(result).replace("{","\n{"));
	}
	@Test
