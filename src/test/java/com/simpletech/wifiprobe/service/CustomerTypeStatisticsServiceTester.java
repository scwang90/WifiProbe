...
public class CustomerTypeStatisticsServiceTester {
	...
	public void customer() throws Exception{
		Object result = service.customer("1", Period.month, monthf.parse("2015-11-01"), monthf.parse("2015-11-30"));
		System.out.println(JacksonUtil.toJson(result).replace("{","\n{"));
	}

	@Test
	public void customerLiveness() throws Exception{
		Object result = service.customerLiveness("1", Period.day, monthf.parse("2015-11-01"), monthf.parse("2015-11-30"));
		System.out.println(JacksonUtil.toJson(result).replace("{","\n{"));
	}
